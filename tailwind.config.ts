  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        'blue-base': '#4981FF',
        'green-base': '#0C8911',
        'light-green-base-hovered': '#DFFFE7',
        'dark-green-base-hovered': '#0B4421',
        'light-blue-base-hovered': '#DEE8FF',
        'dark-blue-base-hovered': '#171E6F',
        'light-orange-base-hovered': '#FFEED9',
        'dark-orange-base-hovered': '#4B230E',
